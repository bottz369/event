...
python3 -m pytest tests/test_smoke_apptest.py tests/test_tt_editor_repro.py tests/test_flyer_scale_link.py tests/test_tab_state_pinning.py tests/test_unified_save.py tests/test_planned_artist_count_ui.py tests/test_selector_label.py tests/test_event_intake.py tests/test_timetable_engine.py tests/test_text_generator.py -v --disable-warnings
